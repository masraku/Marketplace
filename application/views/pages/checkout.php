                        ...
                        <div class="row">
                                        ...
                                        <fieldset>
                                            <div class="row">
                                                <div class="form-group col-12 col-sm-6 col-md-6 col-lg-6">
                                                    ...
                                                    <input name="firstname" value="<?php echo $this->session->userdata('username'); ?>" id="firstname" type="text" required="" class="form-control">
                                                </div>
                                                <div class="form-group col-12 col-sm-6 col-md-6 col-lg-6">
                                                    <label for="lastname" class="form-label">Last Name <span class="required">*</span></label>
                                                    <input name="lastname" value="" id="lastname" type="text" class="form-control">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group col-12 col-sm-12 col-md-12 col-lg-12">
                                                    <label for="address-1" class="form-label">Address <span class="required">*</span></label>
                                                    <input name="address_1" value="<?php echo $this->session->userdata('alamat'); ?>, <?php echo $this->session->userdata('kabupaten'); ?>, <?php echo $this->session->userdata('provinsi'); ?>" id="address-1" type="text" required="" placeholder="Street address" class="form-control">
                                                </div>
                                                <div class="form-group col-12 col-sm-12 col-md-12 col-lg-12">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-12 col-sm-6 col-md-6 col-lg-6">
                                                    ...
                                                    <input name="postcode" value="<?php echo $this->session->userdata('pos'); ?>" id="postcode" type="text" class="form-control">
                                                </div>
                                                <div class="form-group col-12 col-sm-6 col-md-6 col-lg-6">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <div class="block mb-3 delivery-methods mb-4">
                                    <div class="block-content">
                                        <h3 class="title mb-3 text-uppercase">Delivery Methods</h3>
                                        <div class="delivery-methods-content">
                                            <div class="customRadio clearfix">
                                                ...
                                                <label for="formcheckoutRadio1" class="mb-0">Standard Delivery Rp 10.000 (3-5 days)</label>
                                            </div>
                                            <div class="customRadio clearfix">
                                                <input id="formcheckoutRadio2" value="" name="radio1" type="radio" class="radio"> 
                                                <label for="formcheckoutRadio2" class="mb-0">Express Delivery Rp 20.000 (1-2 days)</label>
                                            </div>
                                            <div class="customRadio clearfix mb-0">
                                                <input id="formcheckoutRadio3" value="" name="radio1" type="radio" class="radio"> 
                                                <label for="formcheckoutRadio3" class="mb-0">Same-Day Rp 40.000 (Evening Delivery)</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <fieldset>
                                            <div class="row">
                                                <div class="form-group col-md-12 col-lg-12 col-xl-12 mb-0">
                                                    <textarea class="resize-both form-control" rows="4" placeholder="Place your comment here"></textarea>
                                ...
                                <div class="block mb-3 apply-code mb-4">
                                    <div class="block-content">
                                        <h3 class="title mb-3 text-uppercase">Apply Promocode</h3>
