                    ...
                    <div class="container container-1330">
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-6 col-lg-3 footer-contact order-1 order-lg-0 mt-1 mt-md-4 mt-lg-0">
                                ...
                                <p class="phone d-flex align-items-center"><i class="icon anm anm-phone-l d-none"></i> <b class="me-1">Phone:</b><a href="tel:082146150660">(+62) 821 4615 0660</a></p>
                                <p class="email d-flex align-items-center"><i class="icon anm anm-envelope-l d-none"></i> <b class="me-1">Email:</b> <a href="mailto:info@example.com">rakuuu@gmail.com</a></p>
                                <p class="address d-flex"><i class="icon anm anm-map-marker-al pt-1 d-none"></i> <b class="me-1">Address:</b> FX Sudirman, Jakarta Pusat</p>
                                <p class="work-hour d-flex mb-0"><i class="icon anm anm-clock-r pt-1 d-none"></i><span class="hour-time"><b class="me-1">Working Days / Hours:</b> <br/>Mon - Sun / 9:00 AM - 8:00 PM</span></p>
                            </div>
                                    ...
                                    <div class="row g-2 row-cols-xl-4 row-cols-lg-4 row-cols-md-4 row-cols-sm-4 row-cols-4">  
                                        <div class="instagram-item">
                                            <a href="#;" class="zoom-scal rounded-5">
                                                <img class="rounded-5 blur-up lazyload" src="assets/images/instagram/organic-1.jpg" data-src="assets/images/instagram/organic-1.jpg" alt="image" width="110" height="110" />
                                                <span class="ins-icon d-flex-justify-center"><i class="icon anm anm-instagram"></i></span>
                                            </a>
                                        </div>
                                        <div class="instagram-item">
                                            <a href="#;" class="zoom-scal rounded-5">
                                                <img class="rounded-5 blur-up lazyload" src="assets/images/instagram/organic-2.jpg" data-src="assets/images/instagram/organic-2.jpg" alt="image" width="110" height="110" />
                                                <span class="ins-icon d-flex-justify-center"><i class="icon anm anm-instagram"></i></span>
                                            </a>
                                        </div>
                                        <div class="instagram-item">
                                            <a href="#;" class="zoom-scal rounded-5">
                                                <img class="rounded-5 blur-up lazyload" src="assets/images/instagram/organic-3.jpg" data-src="assets/images/instagram/organic-3.jpg" alt="image" width="110" height="110" />
                                                <span class="ins-icon d-flex-justify-center"><i class="icon anm anm-instagram"></i></span>
                                            </a>
                                        </div>
                                        <div class="instagram-item">
                                            <a href="#;" class="zoom-scal rounded-5">
                                                <img class="rounded-5 blur-up lazyload" src="assets/images/instagram/organic-4.jpg" data-src="assets/images/instagram/organic-4.jpg" alt="image" width="110" height="110" />
                                                <span class="ins-icon d-flex-justify-center"><i class="icon anm anm-instagram"></i></span>
                                            </a>
                                        </div>
                                        <div class="instagram-item">
                                            <a href="#;" class="zoom-scal rounded-5">
                                                <img class="rounded-5 blur-up lazyload" src="assets/images/instagram/organic-5.jpg" data-src="assets/images/instagram/organic-5.jpg" alt="image" width="110" height="110" />
                                                <span class="ins-icon d-flex-justify-center"><i class="icon anm anm-instagram"></i></span>
                                            </a>
                                        </div>
                                        <div class="instagram-item">
                                            <a href="#;" class="zoom-scal rounded-5">
                                                <img class="rounded-5 blur-up lazyload" src="assets/images/instagram/organic-6.jpg" data-src="assets/images/instagram/organic-6.jpg" alt="image" width="110" height="110" />
                                                <span class="ins-icon d-flex-justify-center"><i class="icon anm anm-instagram"></i></span>
                                            </a>
                                        </div>
                                        <div class="instagram-item">
                                            <a href="#;" class="zoom-scal rounded-5">
                                                <img class="rounded-5 blur-up lazyload" src="assets/images/instagram/organic-7.jpg" data-src="assets/images/instagram/organic-7.jpg" alt="image" width="110" height="110" />
                                                <span class="ins-icon d-flex-justify-center"><i class="icon anm anm-instagram"></i></span>
                                            </a>
                                        </div>
                                        <div class="instagram-item">
                                            <a href="#;" class="zoom-scal rounded-5">
                                                <img class="rounded-5 blur-up lazyload" src="assets/images/instagram/organic-8.jpg" data-src="assets/images/instagram/organic-8.jpg" alt="image" width="110" height="110" />
                                                <span class="ins-icon d-flex-justify-center"><i class="icon anm anm-instagram"></i></span>
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <ul class="m-0 clearfix">
                            <li class="item d-flex justify-content-center align-items-center">
                                <a class="product-image rounded-4" href="product-layout1.html">
                                    <img class="rounded-4 blur-up lazyload" data-src="assets/images/products/cart-vegetables-product-img1.jpg" src="assets/images/products/cart-vegetables-product-img1.jpg" alt="product" title="Product" width="120" height="170" />
                                </a>
                            ...
                            <li class="item d-flex justify-content-center align-items-center">
                                <a class="product-image rounded-4" href="product-layout1.html">
                                    <img class="rounded-4 blur-up lazyload" data-src="assets/images/products/cart-vegetables-product-img2.jpg" src="assets/images/products/cart-vegetables-product-img2.jpg" alt="product" title="Product" width="120" height="170" />
                                </a>
                                <div class="product-details">
                        ...
                        <div class="modal-body">
                            ...
                            <form method="post" action="#" id="product-form-quickshop" class="product-form align-items-center">
                                ...
                                <div class="row g-0 item mb-3">
                                    <a class="col-4 product-image" href="product-layout1.html"><img class="rounded-4 blur-up lazyload" data-src="assets/images/products/vegetables-product3.jpg" src="assets/images/products/vegetables-product3.jpg" alt="Product" title="Product" width="400" height="400" /></a>
                                ...
                                <div class="variants-clr swatches-image clearfix mb-3 swatch-0 option1" data-option-index="0">
                                    ...
                                    <ul class="swatches d-flex-justify-center pt-1 clearfix">
                                        <li class="swatch large rounded available active"><img src="assets/images/products/swatches/blue-red.jpg" alt="image" width="70" height="70" data-bs-toggle="tooltip" data-bs-placement="top" title="Blue" /></li>
                                        <li class="swatch large rounded available"><img src="assets/images/products/swatches/blue-red.jpg" alt="image" width="70" height="70" data-bs-toggle="tooltip" data-bs-placement="top" title="Black" /></li>
                                        <li class="swatch large rounded available"><img src="assets/images/products/swatches/blue-red.jpg" alt="image" width="70" height="70" data-bs-toggle="tooltip" data-bs-placement="top" title="Pink" /></li>
                        ...
                        <div class="modal-body">
                            ...
                            <form method="post" action="#" id="product-form-addtocart" class="product-form align-items-center">
                                ...
                                <div class="row d-flex-center text-center">
                                    <div class="col-md-6">
                                        <!-- Product Image -->
                                        <a class="product-image" href="product-layout1.html"><img class="rounded-4 blur-up lazyload" data-src="assets/images/products/vegetables-product4.jpg" src="assets/images/products/vegetables-product4.jpg" alt="Product" title="Product" width="400" height="400" /></a>
                                        <!-- End Product Image -->
                                    </div>
                                    ...
                                    <div id="quickView" class="carousel slide">
                                        ...
                                        <div class="carousel-inner">
                                            <div class="item carousel-item active" data-bs-slide-number="0">
                                                <img class="rounded-4 blur-up lazyload" data-src="assets/images/products/vegetables-product1.jpg" src="assets/images/products/vegetables-product1.jpg" alt="product" title="Product" width="400" height="400" />
                                            </div>
                                            <div class="item carousel-item" data-bs-slide-number="1">
                                                <img class="rounded-4 blur-up lazyload" data-src="assets/images/products/vegetables-product2.jpg" src="assets/images/products/vegetables-product2.jpg" alt="product" title="Product" width="400" height="400" />
                                            </div>
                                            <div class="item carousel-item" data-bs-slide-number="2">
                                                <img class="rounded-4 blur-up lazyload" data-src="assets/images/products/vegetables-product3.jpg" src="assets/images/products/vegetables-product3.jpg" alt="product" title="Product" width="400" height="400" />
                                            </div>
                                            <div class="item carousel-item" data-bs-slide-number="3">
                                                <img class="rounded-4 blur-up lazyload" data-src="assets/images/products/vegetables-product4.jpg" src="assets/images/products/vegetables-product4.jpg" alt="product" title="Product" width="400" height="400" />
                                            </div>
                                            <div class="item carousel-item" data-bs-slide-number="4">
                                                <img class="rounded-4 blur-up lazyload" data-src="assets/images/products/vegetables-product5.jpg" src="assets/images/products/vegetables-product5.jpg" alt="product" title="Product" width="400" height="400" />
                                            </div>
                                            <div class="item carousel-item" data-bs-slide-number="5">
                                                <img class="rounded-4 blur-up lazyload" data-src="assets/images/products/vegetables-product6.jpg" src="assets/images/products/vegetables-product6.jpg" alt="product" title="Product" width="400" height="400" />
                                            </div>
                                        </div>
...
<!-- Mirrored from www.annimexweb.com/items/hema/index7-organic-food.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Sep 2024 03:38:44 GMT -->
</html>