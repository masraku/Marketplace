                            ...
                            <div class="dashboard-sidebar bg-block">
                                <div class="profile-top text-center mb-4 px-3">
                                    ...
                                    <div class="profile-detail">
                                        <h3 class="mb-1"><?php echo $this->session->userdata('username'); ?></h3>
                                ...
                                <div class="dashboard-tab">
                                    <ul class="nav nav-tabs flex-lg-column border-bottom-0" id="top-tab" role="tablist">
                                        ...
                                        <li class="nav-item"><a href="<?php echo base_url('login/keluar'); ?>" class="nav-link">Log Out</a> </li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="tab-pane fade h-100 show active" id="info">
                                    <div class="account-info h-100">
                                        <div class="welcome-msg mb-4">
                                            <h2>Hello, <span class="text-primary"><?php echo $this->session->userdata('username'); ?></span></h2>
                                            ...
                                            <div class="row row-cols-lg-2 row-cols-md-2 row-cols-sm-1 row-cols-1">
                                                <div class="box-info mb-4">
                                                    ...
                                                    <div class="box-content mt-3">
                                                        ...
                                                        <p class="mb-2"><?php echo $this->session->userdata('email'); ?></p>
                                                        <p><a href="<?php echo base_url('change');?>" class="btn-link">Change Password</a></p>
                                                    </div>
                                                </div>
                                                <div class="box-info mb-4">
                                                    <div class="box-title d-flex-center">
                                            ...
                                            <div class="box-info mb-4">
                                                ...
                                                <div class="row row-cols-lg-2 row-cols-md-2 row-cols-sm-1 row-cols-1">
                                                    <div class="box-content mt-3">
                                                        ...
                                                        <address class="mb-2"><?php echo $this->session->userdata('alamat'); ?><br/><?php echo $this->session->userdata('kabupaten'); ?><br/><?php echo $this->session->userdata('provinsi'); ?> <?php echo $this->session->userdata('pos'); ?></address>
                                ...
                                <div class="tab-pane fade h-100" id="profile">
                                    <div class="profile-card mt-0 h-100">                                   
                                        ...
                                        <div class="profile-book-section mb-4">
                                            ...
                                            <div class="details d-flex align-items-center mb-2">
                                                <div class="left">
                                                    <h6 class="mb-0 body-font fw-500">Kabupaten / Kota</h6>
                                                </div>
                                                <div class="right">
                                                    <p><?php echo $this->session->userdata('kabupaten'); ?></p>
                                                </div>
                                            </div>
                                            <div class="details d-flex align-items-center mb-2">
                                                <div class="left">
                                                    <h6 class="mb-0 body-font fw-500">Provinsi</h6>
                                                </div>
                                                <div class="right">
                                            ...
                                            <div class="details d-flex align-items-center mb-2">
                                                <div class="left">
                                                    <h6 class="mb-0 body-font fw-500">Alamat</h6>
                                                </div>
                                                <div class="right">
                                            ...
                                            <div class="details d-flex align-items-center mb-2">
                                                <div class="left">
                                                    <h6 class="mb-0 body-font fw-500">Kode Pos</h6>
                                                </div>
                                                <div class="right">
                                                    <p><?php echo $this->session->userdata('pos'); ?>0</p>
                                                </div>
                                            </div>
                                        </div>  
                                        ...
                                        <div class="profile-login-section">
                                            ...
                                            <div class="details d-flex align-items-center mb-2">
                                                <div class="left">
                                                    <h6 class="mb-0 body-font fw-500">Telephone</h6>
                                                </div>
                                                <div class="right">
                                                    <p><?php echo $this->session->userdata('telephone'); ?></p>
                                                </div>
                                            ...
                                            <div class="details d-flex align-items-center mb-2">
                                                <div class="left">
                                                    <h6 class="mb-0 body-font fw-500">Role</h6>
                                                </div>
                                                <div class="right">
